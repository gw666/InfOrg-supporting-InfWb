...
public class SavePath extends Thread
{
	public void run()
	{
	  try
	  {
		  FileOutputStream fos =
			  new FileOutputStream(System.getProperty("user.dir") +	File.separator + "paths");
		  ObjectOutputStream oos = new ObjectOutputStream(fos);

		  oos.writeObject(MainFrame.defaultOpenPath);

		  oos.writeObject(MainFrame.defaultSavePath);
