...
public class TransferableNode implements Transferable, Serializable
{
	...
	int identifier3;
	Rectangle identifier4;
	NotecardModel transferModel;
	String transferModelType;
	Vector cardIds = new Vector();
	String cardId = new String();

	/* The key belongs to the {"notecard", "contentcard"} set, the value is the
	 * NotecardModel object.
	 */
	Map models = new HashMap();
	Map modelTypes = new HashMap();

	//InfomlType infocard;

	final public static DataFlavor NODE_FLAVOR = new
    					DataFlavor(TransferableNode.class, "TransferableNode");
